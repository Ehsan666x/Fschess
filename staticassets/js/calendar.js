...
const priceedit= document.getElementById("calendar_price_edit");
const pricesave= document.getElementById("calendar_price_save");
const pricecancel= document.getElementById("calendar_price_cancel");
...
function price_edit(){
   ...
   pricecancel.style.display='block';
   pricevalue.contentEditable='true';
   pricevalue.focus();
}
function price_save(){
    pricesave.style.display='none';
    pricecancel.style.display='none';
    priceedit.style.display='block';
    pricevalue.contentEditable='false';
}
function price_cancel(){
    pricesave.style.display='none';
    pricecancel.style.display='none';
    priceedit.style.display='block';
    pricevalue.contentEditable='false';
