// var m=document.getElementById('middle_middle');
// var livegames=document.getElementById('livegames');
// //var m = document.getElementById("element-id");

// c='<h1>hi</h1>'
// b=`<div id=test> ${c}  <div>`;

// livegames.addEventListener('click',render_livegames);

// function render_livegames(){
//     var template = ejs.render(b);
...
if(ppath=='livegames'){
     socket=io.connect('http://localhost/livegames');
}else{ socket=io.connect(`http://localhost/${ppath}`);}




socket.on('disconnect', function () {
    window.location.href='http://localhost/livegames';
